/**
 * SVG icon library — returns SVG markup strings.
 * Keeps all icon definitions in one place.
 */
...
export const icons = {
  ...
  scan: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>`,
  ...
  deselectAll: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/></svg>`,
};
